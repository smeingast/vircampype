...
path_scripts = "/Users/stefan/Dropbox/Projects/VISIONS/scripts/VISIONS/198C-2009E/CrA/CrA_wide_A/"
...
write_scripts(paths_files=paths_files, path_pype=path_pype, path_scripts=path_scripts, archive=False,
              ...
              name_suffix="_A", build_stacks=True, build_tile=True, build_phase3=True)
