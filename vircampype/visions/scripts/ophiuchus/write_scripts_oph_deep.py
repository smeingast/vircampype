...
# Define paths
path_scripts = "/Users/stefan/Dropbox/Projects/VISIONS/scripts/VISIONS/Ophiuchus/Oph_deep/"
...
write_scripts(paths_files=paths_files_j, path_pype=path_pype, path_scripts=path_scripts, archive=False,
              projection="Ophiuchus_deep", additional_source_masks="Ophiuchus_deep", n_jobs=10,
              external_headers=False, reference_mag_lim=(12.5, 15.5), phase3_photerr_internal=0.005,
              name_suffix=None, build_stacks=False, build_tile=True, build_phase3=False, build_class_star_library=False)

# Write scripts for H
write_scripts(paths_files=paths_files_h, path_pype=path_pype, path_scripts=path_scripts, archive=False,
              projection="Ophiuchus_deep", additional_source_masks="Ophiuchus_deep", n_jobs=10,
              external_headers=False, reference_mag_lim=(12.0, 15.0), phase3_photerr_internal=0.005,
              name_suffix=None, build_stacks=False, build_tile=True, build_phase3=False, build_class_star_library=False)

# Write scripts for Ks
write_scripts(paths_files=paths_files_k, path_pype=path_pype, path_scripts=path_scripts, archive=False,
              projection="Ophiuchus_deep", additional_source_masks="Ophiuchus_deep", n_jobs=10,
              external_headers=False, reference_mag_lim=(11.5, 14.5), phase3_photerr_internal=0.005,
              name_suffix=None, build_stacks=False, build_tile=True, build_phase3=False, build_class_star_library=False)
