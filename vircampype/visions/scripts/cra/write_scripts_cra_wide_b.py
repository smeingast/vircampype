...
path_scripts = "/Users/stefan/Dropbox/Projects/VISIONS/Pipeline/scripts/CrA/wide_B/"
...
# Write scripts
write_scripts(
    paths_files=paths_files, path_pype=path_pype, path_scripts=path_scripts, **kwargs
)
