...
# Setup for pipeline
name = "CrA_mosaic_H_lq"
path_scripts = f"{path_visions_proj}Pipeline/scripts/CrA/all_H/"
...
projection = "Corona_Australis_wide_lq"
...
# Remove everything that does not contain the string wide_1_1
paths_scripts = [path for path in paths_scripts if "wide_1_1" in path]
