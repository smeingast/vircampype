...
paths_tiles_wide = sorted(glob("/Volumes/Data/VHS/CrA/vircampype/*GPS*_Ks/tile/*Ks.fits"))
paths_tiles_deep = sorted(glob("/Volumes/Data/VISIONS/198C-2009E/vircampype/CrA_deep_Ks_*/tile/*[1-2].fits"))
